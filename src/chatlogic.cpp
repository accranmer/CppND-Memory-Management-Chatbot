...
ChatLogic::~ChatLogic()
{
    ...
    // delete all nodes
    // Task 3 - unique pointers do not need to be deleted.
    //for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it)
    //{
    //    delete (*it).get(); // Task 3
    //}

    // delete all edges
    // Task 4 - unique pointers do not need to be deleted.
